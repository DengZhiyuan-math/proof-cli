...
- Immediate next step: plan and implement the Phase 1 foundation

## Open Questions

- Exact proof DSL syntax
- The final shape of the contract object
- How much external retrieval to support in the first implementation
