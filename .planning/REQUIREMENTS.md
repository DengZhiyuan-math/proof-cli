...
Use `$gsd-new-milestone` to create the next milestone and populate fresh active requirements.

## Carry-Forward Candidates

These are not active requirements yet. They are preserved here only as likely candidates for the next milestone discussion.
